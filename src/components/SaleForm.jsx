        ...
        <div>
            ...
            <div className="flex gap-2 flex-wrap mt-2">
                ...
                <label className="flex flex-col">
                        ...
                        )} value={userInput.description} type="text" placeholder="Enter Item Name" className="bg-gray-800 text-white border-2 rounded-md max-w-[10rem] px-1 outline-2 outline-blue-500"/>
                </label>
                <label className="flex flex-col">
          Quantity:
          <input
